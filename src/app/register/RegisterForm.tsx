      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', margin: 0, lineHeight: 1.4 }}>
            Create the initial administrator account. This will secure your terminal credentials and F&O trading.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <button
            ...
            disabled={isSubmitting}
          >
            {isSubmitting ? 'Creating Administrator...' : 'Create Admin Account'}
          </button>
        </form>
      </div>
    </div>
